...
class MyWindowClass(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        # Load images into buttons and initialize animations
        ...
        self.energy_timer.start(10000)  # Decrease energy every 10 seconds
    ...
    def load_images_and_animations(self):
        ...
        # Create QPixmap objects for idle, sleeping, walking, and playing frames
        ...
        if self.idle_pixmaps:
            ...
            self.idle_animation_timer.start(300)

    def load_image_into_button(self):
        # Load images and set them as button icons using QtGui.QPixmap
        ...
        # Scale images to fit buttons while preserving aspect ratio
        button_size = self.feed_Button.size()  # Assuming all buttons have the same size
    ...
    def next_walking_frame(self):
        # Advance to the next frame in walking animation
    ...
    def next_playing_frame(self):
        # Advance to the next frame in playing animation
    ...
    def btn_feedClicked(self):
        # Restore happiness, decrease energy, and start cooldown timer
    ...
    def btn_walkClicked(self):
        # Restore mood, decrease energy, and start cooldown timer
    ...
    def btn_doctorClicked(self):
        # Restore health to max value and start cooldown timer
    ...
    def decrease_health_due_to_hunger(self):
        # Decrease health due to critical hunger
    ...
    def start_sleep_animation(self):
        ...
        # Start timer to recover energy every second
    ...
    # Increment energy by 5 points every second during sleep
        if self.energy < 100:
